...
def _generate_executive_summary(overview: Any, quality: Any, recommendations: Any) -> str:
...
def auditor_node(state: FinSightState) -> Dict[str, Any]:
    ...
    if raw_df is None or raw_df.empty:
        ...
        return {"agent_logs": [{"agent_name": agent_name, "status": "FAILED", "timestamp": datetime.now(timezone.utc), "message": "No valid dataset provided."}]}
